...
public interface IContentService
{
    ...
    Task<ServiceResult<string>> CopyContentsToEnrollUser(SummaryMatriculationRequest request, string ownerId, string companyRef, string document, CancellationToken cancellationToken = default);
